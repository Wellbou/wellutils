...
_T_EN[usb_type_serial]="Serial/UART"
...
_T_EN[sens_disk_standby]="standby (spun down)"
_T_EN[sens_cpu]="CPU"
...
_T_EN[cmd_html]="Render this report as an HTML page"
...
_T_EN[cmd_report]="Rich, self-contained HTML system report (offline)"
...
_T_EN[doc_confleft]="leftover config"
_T_EN[doc_confleft_more]="and more leftovers"
_T_EN[doc_confleft_count]="leftover config files"
_T_EN[doc_confleft_ok]="no leftover config files"
_T_EN[doc_confleft_hint]="review and clean up"
_T_EN[doc_confleft_na]="no native package manager detected"
_T_EN[doc_orphan_count]="orphan packages"
_T_EN[doc_orphan_ok]="no orphan packages"
_T_EN[doc_orphan_na]="orphan check unsupported on this package manager"
...
_T_EN[mem_module_one]="module"
_T_EN[mem_module_few]="modules"
_T_EN[mem_module_many]="modules"

_T_EN[pwr_thr_start]="start"
_T_EN[pwr_thr_stop]="stop"
_T_EN[pwr_profile]="Profile"
_T_EN[hw_ram_downclock]="clocked down to the slowest module:"
_T_EN[hw_ram_mixed]="mixed types"
_T_EN[hw_ram_single_ch]="single-channel (half the memory bandwidth)"
_T_EN[hw_need_python]="python3 is required for --snapshot/--diff"
_T_EN[blk_network]="Network block device"
_T_EN[blk_none]="no disks found"
_T_EN[blk_virtual_one]="Virtual"
_T_EN[usb_hubs]="hubs"
_T_EN[usb_no_sysfs]="USB information is unavailable: /sys/bus/usb is missing (no USB bus, container or restricted system)"
_T_EN[pci_shown]="Expansion cards"
_T_EN[pci_of]="of"
_T_EN[pci_hint_all]="chipset and built-in devices are hidden, use --all to list every PCI device"
_T_EN[mod_deps_title]="Dependencies"
_T_EN[mod_none]="No loadable modules found (/proc/modules is unavailable or the kernel has no module support)"
_T_EN[net_total]="Total"
_T_EN[kind_virtio]="virtio (VM)"
_T_EN[updu_sum_fail]="SHA256 checksum mismatch: the downloaded archive was rejected."
...
_T_RU[pwr_thr_start]="начало"
_T_RU[pwr_thr_stop]="конец"
_T_RU[pwr_profile]="Профиль"
_T_RU[hw_ram_downclock]="частота снижена до самого медленного модуля:"
_T_RU[hw_ram_mixed]="разные типы"
_T_RU[hw_ram_single_ch]="одноканальный режим (пропускная способность вдвое ниже)"
_T_RU[hw_need_python]="для --snapshot/--diff нужен python3"
_T_RU[blk_network]="Сетевое блочное устройство"
_T_RU[blk_none]="диски не найдены"
_T_RU[blk_virtual_one]="Виртуальный"
_T_RU[usb_hubs]="хабов"
_T_RU[usb_no_sysfs]="Сведения об USB недоступны: нет /sys/bus/usb (нет шины USB, контейнер или ограниченная система)"
_T_RU[pci_shown]="Карты расширения"
_T_RU[pci_of]="из"
_T_RU[pci_hint_all]="чипсет и встроенные устройства скрыты, --all покажет все PCI-устройства"
_T_RU[mod_deps_title]="Зависимости"
_T_RU[mod_none]="Загружаемые модули не найдены (/proc/modules недоступен или ядро собрано без поддержки модулей)"
_T_RU[net_total]="Всего"
_T_RU[kind_virtio]="virtio (ВМ)"
_T_RU[updu_sum_fail]="Несовпадение контрольной суммы SHA256: скачанный архив отклонён."
_T_RU[updu_pkg_owned]="wellutils установлен системным пакетным менеджером"
_T_RU[updu_pkg_hint]="Обновляйте его пакетным менеджером (например, wellup), а не через --self-update."
_T_RU[done]="Отчёт сохранён:"
_T_RU[mem_module_one]="модуль"
_T_RU[mem_module_few]="модуля"
_T_RU[mem_module_many]="модулей"
...
_T_RU[usb_type_serial]="Последовательный порт"
...
_T_RU[sens_disk_standby]="ожидание (диск остановлен)"
_T_RU[sens_cpu]="CPU"
...
_T_RU[cmd_html]="Вывести этот отчёт как HTML-страницу"
...
_T_RU[cmd_report]="Богатый HTML-отчёт по системе (офлайн)"
...
_T_RU[doc_confleft]="Оставшийся конфиг"
_T_RU[doc_confleft_more]="и ещё остатков"
_T_RU[doc_confleft_count]="Остатки конфигов"
_T_RU[doc_confleft_ok]="Остатков конфигов нет"
_T_RU[doc_confleft_hint]="просмотрите и уберите"
_T_RU[doc_confleft_na]="родной менеджер пакетов не определён"
_T_RU[doc_orphan_count]="Осиротевшие пакеты"
_T_RU[doc_orphan_ok]="Осиротевших пакетов нет"
_T_RU[doc_orphan_na]="проверка сирот не поддерживается этим менеджером пакетов"
