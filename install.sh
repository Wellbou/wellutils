...
TOOLS="wellper wellmem wellhw wellusb wellpci wellblock wellcpu wellgpu wellmod wellsensors wellfetch wellup wellnet wellpower welldoctor wellhtml wellutils"
