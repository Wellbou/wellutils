...
GTX 1050 Ti, два монитора 20" 1600x900). Рамки и выравнивание
...
```text
  ...
  │  CPU0  █████████████░   95%  @ 3.50 GHz  (schedutil)│
  │  CPU1  █████████████░   95%  @ 3.50 GHz  (schedutil)│
  │  CPU2  █████████████░   95%  @ 3.50 GHz  (schedutil)│
  │  CPU3  ██████████████  100%  @ 3.50 GHz  (schedutil)│
  │  CPU4  █████████████░   95%  @ 3.50 GHz  (schedutil)│
  │  CPU5  █████████████░   95%  @ 3.50 GHz  (schedutil)│
  │  CPU6  ██████████████  100%  @ 3.50 GHz  (schedutil)│
  │  CPU7  ██████████████  100%  @ 3.50 GHz  (schedutil)│
  └─────────────────────────────────────────────────────┘

  WellCPU v1.0 | 2026-09-08 00:05:17
...
```text
  ...
  │                                                                            │
  │  Всего:           7.7 GiB                                                  │
  │  Использовано:    7.3 GiB                                                  │
  │  Доступно:       394.5 MiB                                                 │
  │  Буферы:          4.4 MiB                                                  │
  │  Кэш:            879.4 MiB                                                 │
  │  Разделяемая:    16.6 MiB                                                  │
  │  Свободно:       211.2 MiB                                                 │
  │                                                                            │
  │  🔄 ПОДКАЧКА                                                               │
  │  ██████████░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░ 25% использовано                 │
  │  Всего: 23.4 GiB  Использовано: 6.1 GiB  Свободно: 17.4 GiB                │
  │                                                                            │
  │  📦 ZRAM -- сжатая RAM                                                     │
  │  Размер: 15.4 GiB  Алгоритм: zstd                                          │
  │  Данные: 2.2 GiB  Сжато: 671.8 MiB  (Степень: 3.3x)                        │
  │                                                                            │
  │  🧬 DIMM (2 модулей)                                                       │
  ...
  WellMem v1.1 | 2026-09-08 00:05:18
...
```text
  ...
  │  💾 Драйвер:          580.173.02                            │
  │  🌡 Температура:      44°C                                  │
  │  🧩 VRAM:             1072 / 4096 MiB  26%                  │
  │  ⚡ Загрузка:         22%                                    │
  │  🕐 Частоты:          734 MHz  /  mem 810 MHz               │
  │  🔌 Питание:          ~40.50 W                              │
  │  🌀 Вентилятор:       0%                                    │
  └─────────────────────────────────────────────────────────────┘

  WellGPU v1.0 | 2026-09-08 00:05:19
...
```text
  ...
  │  📊 Загрузка:     23.28 20.61 14.28  (1/5/15 min)                       │
  │  🧠 RAM:          7489 MB / 7896 MB  (94%)                              │
  │  ⏱ Аптайм:       13 hours, 28 minutes                                   │
  └─────────────────────────────────────────────────────────────────────────┘
  ┌─── 🔥 ЯДРА CPU───────────────────┐
  │  🌋 Package id 0     67°C  ▁▂▃▄▅▆│
  │  🌋 Core 0           67°C  ▁▂▃▄▅▆│
  ...
  └──────────────────────────────────┘
  ┌─── 🎮 GPU──────────────────────────────────────────────────┐
  │  🌊 MSI GeForce GTX 1050 Ti   44°C  ▁▂▃▄                   │
  │    ├── Fan: 0%  |  Power: N/A  |  GPU: 734 MHz             │
  │    ├── VRAM: 1072 / 4096 MiB  |  Util: 20%  |  Mem: 810 MHz│
  └────────────────────────────────────────────────────────────┘
  ...
  ╔════════════════════════════════════════════════╗
  ║  📈 МИН   27°C   📉 СРД   50°C   🔺 МАКС   68°C║
  ╚════════════════════════════════════════════════╝

  WellSensors v1.3 | 2026-09-08 00:05:23
...
```text
  ...
  │       └─ tailscale0 unknown                              │
  │       └─ tun0 unknown                                    │
  │       └─ wlp4s0 down 5e:87:08:5b:78:53                   │
  └──────────────────────────────────────────────────────────┘
  ┌─── 🌀 Вентилятор───────────────────────────────────────┐
  │  🌀 Вентилятор:    Вентилятор 1 2051 RPM (f71882fg.656)│
  └────────────────────────────────────────────────────────┘
  ...
  WellHW v1.3 | 2026-09-08 00:05:26
...
```text
  ...
  WellUSB v2.0 | 2026-09-08 00:05:30
...
```text
  ...
  WellPCI v2.1 | 2026-09-08 00:05:31
...
```text
  ...
  WellBlock v1.1 | 2026-09-08 00:05:33
...
```text
  ...
  WellPer v1.0 | 2026-09-08 00:05:35
...
```text
  ...
  │ 🔌  tailscale0 [up]  vpn                           │
  │ 🔌  tun0 [up]  vpn                                 │
  │ 🔌  wlp4s0 [down]  wifi  5e:87:08:5b:78:53         │
  └────────────────────────────────────────────────────┘
  ┌─── 🌐 Адреса───────────────────────────────────────────────────────────────────────────────────┐
  ...
  │       └─ 🌐  docker0  DOWN 172.17.0.1/16 fe80::c8c2:c8ff:fe69:a1fe/64                          │
  ...
  │ 👂  Слушателей: TCP 0 · UDP 1032│
  └─────────────────────────────────┘
  ┌─── 📊 Трафик (с загрузки)────────────────────────┐
  │ 📊  enp0s29u1u5: ↓ приём 391 MiB · ↑ отдача 5 GiB│
  │ 📊  tun0: ↓ приём 335 MiB · ↑ отдача 8 GiB       │
  │ 📊  tailscale0: ↓ приём 3 KiB · ↑ отдача 5 KiB   │
  │ 📊  docker0: ↓ приём 56 B · ↑ отдача 1 KiB       │
  │ 📊  wlp4s0: ↓ приём 0 B · ↑ отдача 0 B           │
  │ 📊  enp6s0: ↓ приём 0 B · ↑ отдача 0 B           │
  │ Σ  net_total: ↓ 726 MiB · ↑ 13 GiB                │
  └──────────────────────────────────────────────────┘

  WellNet v1.0 | 2026-09-08 00:05:40
...
```text
  ...
  WellPower v1.0 | 2026-09-08 00:05:40
...
```text
  ...
  WellDoctor v1.0 | 2026-09-08 00:05:43
...
```text
  ...
  WellUp v1.0 | 2026-09-08 00:05:55
...
```text
  ...
  │     /\   \        ◈ Ядро: 7.1.8-arch1-3                                   │
  │    /  __  \       ◔ Аптайм: 13h 28m · загрузка 2026-09-07 10:37           │
  │   /  (  )  \      ▚ Процессор: Intel(R) Xeon(R) CPU E3-1230 V2 @ 3.30GHz  │
  │  / __|  |__ \           4 ядра / 8 потоков @ 3500 МГц · нагрузка 22.63    │
  │ /.`        `.\    ▞ Видеокарта: GP107 [GeForce GTX 1050 Ti] · 4 GiB       │
  │                   ▤ Память: 7.1 GiB / 7.7 GiB (92%)                       │
  │                   ▣ Разрешение: 1600x900                                  │
  ...
  WellFetch v1.4.0 | 2026-09-08 00:05:57
